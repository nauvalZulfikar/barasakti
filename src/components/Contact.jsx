  ...
  return (
    <section id="contact" className="px-[6%] py-24 bg-[#0a0f1e]">
      <div ref={ref} className="max-w-6xl mx-auto">
        <p className="text-[#00d4ff] text-xs font-semibold uppercase tracking-[3px] mb-3">
          {c.tag}
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
          ...
          <div className="flex flex-col gap-4">
            ...
            >
              ...
              <div>
                <div className="text-[#9ca3af] text-xs uppercase tracking-widest mb-0.5">
                  {c.labels.phone}
                </div>
                <div className="text-[#f9fafb] font-semibold text-sm">
                  +62 812-2188-2882
                </div>
              </div>
            </a>
            <a
              href="https://wa.me/628122188882"
              target="_blank"
            ...
            <a
              href="mailto:bangbang@barasakti.com"
              className="flex items-center gap-4 bg-[#1f2937] border border-[#374151] rounded-xl px-6 py-5 hover:border-[#00d4ff] transition-colors no-underline"
            >
              ...
              <div>
                ...
                <div className="text-[#f9fafb] font-semibold text-sm">
                  bangbang@barasakti.com
                </div>
              </div>
            </a>
            <div className="bg-[#1f2937] border border-[#374151] rounded-xl px-6 py-5">
              <div className="text-[#9ca3af] text-xs uppercase tracking-widest mb-2">
                {c.labels.address}
              </div>
              <div className="text-[#f9fafb] text-sm leading-relaxed">
                {c.address}
              </div>
            </div>
            <div className="bg-[#1f2937] border border-[#374151] rounded-xl px-6 py-5">
              ...
              <div className="text-[#f9fafb] font-bold">
                PT. Bara Sakti Ziwa Abadi
              </div>
              <div className="text-[#9ca3af] text-sm mt-1">
                HVAC | Automation Control | Panel Maker | Design & Engineering
              </div>
            </div>
